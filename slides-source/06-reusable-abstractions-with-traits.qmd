...
::: notes
Use this as a compact bridge from generic structs to trait bounds from crates.
:::
...
::: notes
Point out that these traits come from `num-traits`, not the standard library.
This is common in scientific Rust when generic numeric code needs explicit
capabilities.
:::
