...
## Modules 10-15: Scientific Workflows
...
parallelism, structured output, diagnostics, visualization, and
multidimensional arrays. The final module starts with a home-grown C++ library
with no Rust bindings, then progresses through raw and safe wrappers for an
established HPC library.
:::
...
- Leave N-body, heat diffusion, and FFI as follow-up or optional labs
