...
| Shared package code in `lib.rs` | `source-code/hashmap-hashset/src/lib.rs` |
...
| Feature | Where to look |
|---|---|
| Defining a `struct` | `source-code/structs-and-methods/src/matrix.rs`, `source-code/n-body-simulation/src/system.rs` |
| Private fields with public methods | `source-code/structs-and-methods/src/matrix.rs`, `source-code/n-body-simulation/src/system.rs` |
| Associated constructor `new` | `source-code/structs-and-methods/src/matrix.rs`, `source-code/n-body-simulation/src/system.rs` |
| `impl` blocks | `source-code/structs-and-methods/src/matrix.rs`, `source-code/n-body-simulation/src/system.rs` |
...
- integration tests and larger reusable library-plus-binary layouts;
